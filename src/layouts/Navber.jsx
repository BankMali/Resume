...
export default function Navber() {
  return (
    <div className="text-[12px] px-10 py-3 w-full flex flex-wrap justify-between items-center gap-2 max-sm:justify-center sticky top-0 bg-c-gray2 backdrop-blur-sm bg-opacity-0 z-[41] max-sm:bg-opacity-20">
      <Link to="/">
